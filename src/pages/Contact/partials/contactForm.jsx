    ...
    return (
        <>
            <section className="text-gray-600 body-font relative">
                <div className="w-[70vw] container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                    ...
                    <div className="lg:w-1/2 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                        ...
                        <button className="text-white w-[10vw] rounded-3xl bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded text-lg">
                            Send
                        </button>
                    </div>
                </div>
